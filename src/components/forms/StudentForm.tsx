  ...
  return (
    <form className='flex flex-col gap-8' onSubmit={onSubmit}>
        ...
        <div className='flex justify-between flex-wrap gap-4'>
          ...
          <InputField label="Email" name="email" type='email' defaultValue={data?.username} register={register} error={errors.username} />
          <InputField label="Password" name="password" type='password' defaultValue={data?.username} register={register} error={errors.username} />
        </div>
        ...
        <div className='flex justify-between flex-wrap gap-4'>
          ...
          <div className='flex flex-col gap-2 w-full md:w-1/4 justify-center mt-4'>
